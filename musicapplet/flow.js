...
var notes = [
    ...
    new VF.StaveNote({clef: "treble", keys: ["f#/4"], duration: "q" }).addAccidental(2, new VF.Accidental("#")),
    new VF.StaveNote({clef: "treble", keys: ["g/4"], duration: "q" }),
    new VF.StaveNote({clef: "treble", keys: ["g#/4"], duration: "q" }).addAccidental(2, new VF.Accidental("#")),
    new VF.StaveNote({clef: "treble", keys: ["a/4"], duration: "q" }),
    new VF.StaveNote({clef: "treble", keys: ["a#/4"], duration: "q" }).addAccidental(2, new VF.Accidental("#")),
    new VF.StaveNote({clef: "treble", keys: ["b/4"], duration: "q" }),
    new VF.StaveNote({clef: "treble", keys: ["c/5"], duration: "q" }),
    new VF.StaveNote({clef: "treble", keys: ["c#/5"], duration: "q" }).addAccidental(2, new VF.Accidental("#")),
    new VF.StaveNote({clef: "treble", keys: ["d/5"], duration: "q" }),
    new VF.StaveNote({clef: "treble", keys: ["d#/5"], duration: "q" }).addAccidental(2, new VF.Accidental("#"))
]
